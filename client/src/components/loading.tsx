        ...
        <div className="mr-5  grid w-4/6 grid-cols-2 grid-rows-4 gap-5">
          <div className="col-span-2 w-full">
            ...
            <ul className="mb-5 flex">
              <li className="mr-5 flex h-96 w-96 items-center rounded-lg border-2 border-solid border-gray-300 bg-gray-300 p-5 first-line:flex-col">
                <div className=" h-20 w-full place-self-end rounded-lg bg-light-lighter p-2">
